...
(async()=>{
  ...
  await browser.close();fs.writeFileSync(path.join(root,'wordpress/audit',process.env.ARDEN_SYSTEMS_OUTPUT||'task08_7-systems.json'),JSON.stringify(results,null,2));console.log(JSON.stringify(results,null,2));
