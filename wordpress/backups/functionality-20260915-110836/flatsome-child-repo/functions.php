...
function arden_child_enqueue_assets() {
	...
	if ( is_singular( 'page' ) ) {
		...
		if ( false !== strpos( $content, 'arden-react-page' ) ) {
			...
			if ( false !== strpos( $content, 'arden-react-page--about' ) ) {
				wp_enqueue_style( 'arden-about-fidelity', get_stylesheet_directory_uri() . '/assets/css/about-fidelity.css', array( 'arden-react-utility-compat' ), ARDEN_THEME_VERSION . '.' . filemtime( get_stylesheet_directory() . '/assets/css/about-fidelity.css' ) );
			}
			if ( false !== strpos( $content, 'arden-react-page--manufacturing' ) ) {
				wp_enqueue_style( 'arden-manufacturing-fidelity', get_stylesheet_directory_uri() . '/assets/css/manufacturing-fidelity.css', array( 'arden-react-utility-compat' ), ARDEN_THEME_VERSION . '.' . filemtime( get_stylesheet_directory() . '/assets/css/manufacturing-fidelity.css' ) );
			}
			if ( false !== strpos( $content, 'arden-react-page--contact' ) ) {
				wp_enqueue_style( 'arden-contact-fidelity', get_stylesheet_directory_uri() . '/assets/css/contact-fidelity.css', array( 'arden-react-utility-compat' ), ARDEN_THEME_VERSION . '.' . filemtime( get_stylesheet_directory() . '/assets/css/contact-fidelity.css' ) );
			}
		}
	}
}
