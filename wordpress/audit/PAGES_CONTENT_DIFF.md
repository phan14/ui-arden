...
| TShirtServicePage | FAIL | PASS | PASS | FAIL | FAIL |

**Differences remain; see validation JSON.**

Dynamic WordPress templates intentionally source titles, excerpts, images, dates, categories and content from WordPress records. Their production content cannot be declared equal until records are populated and validated.
